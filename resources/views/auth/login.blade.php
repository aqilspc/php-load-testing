...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <p class="mb-1">
       <!--  <a href="#" onclick="return alert('Silahkan hubungi dosen anda')">Lupa Password</a> -->
      </p>
      <p class="mb-0" align="center">
        <a href="#" style="color: black" class="text-center">Copyright © {{date('Y')}} | Clipedia</a>
      </p>
    </div>
    <!-- /.login-card-body -->
  </div>
